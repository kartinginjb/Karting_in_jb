...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.KiJBBasic.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.KiJBBasic.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }

        public void DeleteEntry()
        {
            Leaderboards.KiJBBasic.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.KiJBBasic.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
