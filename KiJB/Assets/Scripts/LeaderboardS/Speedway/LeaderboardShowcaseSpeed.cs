...
namespace Dan.Demo
{
    public class LeaderboardShowcaseSpeed : MonoBehaviour
    {
        [Header("Gameplay:")]
        ...
        public void Load()
        {
            ...
            Leaderboards.KiJBSpeed.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            ...
            Leaderboards.KiJBSpeed.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }

        public void DeleteEntry()
        {
            // ✅ Permite apagar entrada mesmo que não haja tempo
            Leaderboards.KiJBSpeed.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.KiJBSpeed.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
